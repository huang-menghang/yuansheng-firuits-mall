	...
	table.on('tool(table-data)',function(obj){  
		   ...
		   if(obj.event === 'detail'){
	    	   ...
	    	   var callback = {
	    			   ok:function(){
	    				   $.ajax({
	    					 url:basePath+"categoryList/"+data.id,
	    					 method:'post',
	    					 data:{_method:'put'},
	    	   ...
	    	   common_ops.x_admin_show("轮播图编辑", basePath+"categoryList/edit?id="+data.id, '750', '600');	    	   
	       }
		});
	 $('#btn-delete-all').on('click',function(){
		  ...
		  $.ajax({
			  url:basePath+'categoryList/delete/batch',
			  method:'post',
	 ...
	 $("#btn-add").on("click",function(){
			 ...
			 common_ops.x_admin_show("轮播图添加",basePath+"categoryList/add", '750', '600');
