...
<div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <select name="brandName"  lay-verify="required" id = "brandName">
         ...
         <div class="layui-input-inline">
        <select name="packet"  lay-verify="required" id = "packet">
	...
	<div class="layui-upload">
			  ...
			  <button type="button" class="layui-btn layui-btn-normal" id="chooseFile">替换图片</button>
...
<script type="text/javascript" src="<%=basePath %>static/js/goods/edit.js"></script>
</body>
</html>